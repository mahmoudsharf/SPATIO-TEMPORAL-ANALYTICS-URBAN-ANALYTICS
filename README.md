...
1)Create a github repo (you have to create an account if you don’t already have one!)
2)In the top right of the OpenRefine console, click “Export”>Comma-separated value to save your cleaned data file as a csv file.  
3)Add this CSV file to the github repo
4)Add your name and link to github repo to the spreadsheet in: https://docs.google.com/spreadsheets/d/1pnQI4suUTo1Hj8vkuxFuRXexcNorN5UqzmkOCrHHCZE/edit?usp=sharing
